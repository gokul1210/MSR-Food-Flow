    ...
    <nav className="glass-panel sticky top-0 z-50 rounded-none border-t-0 border-l-0 border-r-0 border-b border-white/10 print:hidden">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/home" className="flex items-center gap-3 text-primary font-bold text-2xl tracking-wide z-50">
          <img src="Logo.png" alt="MSR Food Flow Logo" className="h-10 md:h-12 w-auto object-contain rounded-full shadow-lg shadow-orange-500/20" />
      ...
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-[#15161a] border-b border-white/10 shadow-2xl transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-96 py-4 opacity-100' : 'max-h-0 opacity-0 pointer-events-none'
          }`}
      >
